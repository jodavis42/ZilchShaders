...
size_t WriteToHex(char* buffer, size_t bufferSize, u64 integerValue, bool exclude0x = false);
size_t WriteToHex(char* buffer, size_t bufferSize, u32 integerValue, bool exclude0x = false);
...
size_t WriteToHexSize(char* buffer, size_t bufferSize, size_t places, u64 integerValue, bool exclude0x = false);
...
void ConvertUnicodeToAscii(char* destAscii, size_t destAsciiLength, const wchar_t* unicodeData, size_t unicodeLength);
...
size_t ToBuffer(char* buffer, size_t bufferSize, String value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, StringRange value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, bool value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, char value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, int8 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, int16 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, int32 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, int64 value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, uint8 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, uint16 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, uint32 value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, uint64 value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, ulong value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, float value, bool shortFormat = false);
size_t ToBuffer(char* buffer, size_t bufferSize, double value, bool shortFormat = false);

size_t ToBuffer(char* buffer, size_t bufferSize, Guid value, bool shortFormat = false);
