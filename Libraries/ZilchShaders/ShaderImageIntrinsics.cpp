...
void WriteImageArguments(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, ZilchShaderIROp* result, u32 index, ImageUserData& imageData, ZilchSpirVFrontEndContext* context)
{
